...
import { type ThemeDefinition, defineTheme } from "@kobalte/solidbase/config";
...
const defaultTheme: ThemeDefinition<DefaultThemeConfig> = defineTheme({
  componentsPath: import.meta.resolve("./src/theme/components"),
  vite(config) {
    const rootPath = fileURLToPath(import.meta.resolve("./context.tsx"));
