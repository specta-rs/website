...
From 13/03/2026 to xx/xx/2026

Focus: Publish `-rc.24` as it contains a massive core overhaul and breaking changes.

{/* Immediate focus: fix test suite failures and get test suite passing again. */}
...
Priorities:
 ...
 - General cleanup & documentation - 16 hours
    ...
    - Cleanup `specta::internal` - [#352](https://github.com/specta-rs/specta/issues/352)
