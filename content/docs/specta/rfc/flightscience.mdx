...
Cut release [2.0.0-rc.23]()

### Fresh work

Writeup better:
 - Stricter enum types - closes [#221](https://github.com/specta-rs/specta/issues/221)
 - `Result` changes with named data type and how that makes exporters more powerful.

Changes:
 - Rename `specta::datatype::Runtime*` to drop the the unnecessary `Runtime` - [89cb19d](https://github.com/specta-rs/specta/commit/89cb19dcabe57e55db7cce4906f4c39d74b38a8d)
 - Review all `#[doc(hidden)]` stuff - [9a13b7e](https://github.com/specta-rs/specta/commit/9a13b7eb4e16b021ef6ded1aaf537a53964eafe6) closes [#325](https://github.com/specta-rs/specta/issues/325)
 - Overhaul built in implementations for `Type` - done in [#454](https://github.com/specta-rs/specta/pull/454) - closes [#415](https://github.com/specta-rs/specta/issues/415)
...
Thursday:
 - [ ] https://github.com/specta-rs/specta/pull/454
 - [ ] https://github.com/specta-rs/specta/issues/402
 - [ ] https://github.com/specta-rs/specta/issues/86
 - [ ] Release notes + thank John.
 - [ ] https://github.com/specta-rs/specta/issues/100
 - [ ] https://github.com/specta-rs/specta/issues/299
 - [ ] https://github.com/specta-rs/specta/issues/133
 - [ ] https://github.com/specta-rs/specta/issues/68
 - [ ] https://github.com/specta-rs/specta/issues/131
 - [ ] https://github.com/specta-rs/specta/issues/76
 - [ ] https://github.com/specta-rs/specta/issues/431
 - [ ] https://github.com/specta-rs/specta/issues/352

 - [ ] https://github.com/specta-rs/specta/issues/135

 - Error overhaul:
  - [ ] https://github.com/specta-rs/specta/issues/312
  - [ ] https://github.com/specta-rs/specta/issues/345
  - [ ] https://github.com/specta-rs/specta/issues/356
  - [ ] https://github.com/specta-rs/specta/issues/135

Friday:
 - Generics overhaul
    - [ ] https://github.com/specta-rs/specta/issues/138
    - [ ] https://github.com/specta-rs/specta/issues/349
    - [ ] https://github.com/specta-rs/specta/issues/17
    - [ ] https://github.com/specta-rs/specta/issues/44
    - [ ] https://github.com/specta-rs/specta/issues/16

Sunday:
 - Nuanced types work (https://github.com/specta-rs/specta/issues/203):
    - [ ] https://github.com/specta-rs/specta/issues/440
    - [ ] https://github.com/specta-rs/specta/issues/46
    - [ ] https://github.com/specta-rs/specta/issues/190
    - [ ] Tauri Specta prototype
    - [ ] TauRPC prototype

Tuesday:
 - Specta Serde split
    - [ ] https://github.com/specta-rs/specta/issues/438
    - [ ] Tauri Specta multi-phase
    - [ ] TauRPC multi-phase

Wednesday:
 - OpenAPI exporter - https://github.com/specta-rs/specta/issues/31
 - Zod exporter - https://github.com/specta-rs/specta/pull/421
 - Typesafe error handling TauRPC

Thursday:
 - Work through "// TODO: Fix this"'s in the test suite."
 - Cut next `2.0.0.rc-24` release
...
Planned:
- Tauri Specta macro: - https://github.com/specta-rs/specta/issues/213
- Drop `specta::function` + `specta::specta` in preparation from upstream changes???
