...
import vscodeIntegrationImg from "../images/vscode-integration.png";
*/
...
{/* // TODO: Add create rspc-app support here */}
...
function SomeComponent() {
  const version = rspc.createQuery(() => ({
    queryKey: ["version"],
  }));
...
If you are using [Visual Studio Code](https://code.visualstudio.com) you can optionally install the [rspc extension](https://marketplace.visualstudio.com/items?itemName=oscartbeaumont.rspc-vscode) for useful code shortcuts.

<br />

{/* TODO: <Image src={vscodeIntegrationImg} alt="rspc VSCode integration" /> */}
