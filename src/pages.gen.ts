...
type Page =
  ...
  | ({ path: "/_api/docs/[...slug]/llms.mdx" } & GetConfigResponse<
      typeof File_ApiDocsSlugLlmsMdx_getConfig
    >)
  | ({ path: "/_api/docs/[...slug]/og.png" } & GetConfigResponse<
      typeof File_ApiDocsSlugOgPng_getConfig
    >)
  | ({ path: "/_api/docs/llms.mdx" } & GetConfigResponse<
      typeof File_ApiDocsLlmsMdx_getConfig
    >)
  | ({ path: "/_api/docs/og.png" } & GetConfigResponse<
      typeof File_ApiDocsOgPng_getConfig
    >)
  | ({ path: "/_root" } & GetConfigResponse<typeof File_Root_getConfig>)
  | ({ path: "/docs/[...slugs]" } & GetConfigResponse<
      typeof File_DocsSlugs_getConfig
    >);
